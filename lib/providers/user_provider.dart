...
class UserProvider extends ChangeNotifier {
  ...
  // Check if user is logged in - either has user info OR has refresh token
  bool get isLoggedIn {
    // Nếu có user info thì đã đăng nhập
    if (_userInfo != null) return true;
    
    // Nếu không có user info nhưng có refresh token, coi như đã đăng nhập
    // (có thể là do lỗi mạng tạm thời)
    return _hasRefreshToken;
  }
